...
/**
 * convert - convert a data set to the rigth format
 * @hexa_dec: hexa decimal
 * @num: number
 * @base: the bade to convert the number to
 *
 ...
 * Description: This fubction return a length for some string
 * @s: pointer char
 * Return: int length
 */
int _strlen(char *s)
